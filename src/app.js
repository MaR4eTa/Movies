...
function getMovie(movie_id) {
    ...
    axios
        .get(
            ...
            id +
            "?api_key=a993addbd8ef2c8b941f50964963790d"
        )
        .then(response => {
        ...
        <div class="row">
          <div class="well">
            ...
            <a href="http://imdb.com/title/${
                movie.imdb_id
            }" target="_blank" class="btn btn-primary">View TMDb</a>
...
function getMovies(searchText) {
    axios
        .get(
            "https://api.themoviedb.org/3/search/movie?api_key=a993addbd8ef2c8b941f50964963790d&language=en-US&query=" +
            searchText
        )
        .then(response => {
            console.log(response);
